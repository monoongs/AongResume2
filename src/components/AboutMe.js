          ...
          <div className="
            ...
            <div className="wrap flex flex-row items-center ">
              ...
              <div className="flex w-15r md:w-25r justify-center">
                <p className="text-white text-sm md:text-base lg:text-lg "><span className='text-2xl'>H</span>ello ! I'm {fname} {lname} {age} year-old, I am a Programmer working on creating a website, I can do frontend backend and database, I have knowledge about framework such as Laravel Nodejs Reactjs Spring etc, I was learn and practiced about that by myself and experience.</p>      
              </div>
              <div className="flex text-center justify-center w-2.5r md:w-12r">
